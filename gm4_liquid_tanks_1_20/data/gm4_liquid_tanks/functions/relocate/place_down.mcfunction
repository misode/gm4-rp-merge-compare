...
summon armor_stand ~ ~-0.5 ~ {CustomName:'"gm4_liquid_tank"',Tags:["gm4_no_edit","gm4_liquid_tank"],NoGravity:1,Marker:1,Silent:1,Invisible:1,Invulnerable:1,Small:1,DisabledSlots:2039552,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1,tag:{CustomModelData:3420001}}]}
