...
execute anchored eyes positioned ^ ^ ^0.5 if block ~ ~ ~ hopper align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=marker, tag=gm4_liquid_tank, distance=..0.1] run function #gm4_liquid_tanks:level_report_check
