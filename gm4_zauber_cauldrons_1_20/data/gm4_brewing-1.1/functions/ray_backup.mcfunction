...
# run from gm4_brewing-1.1:place_brewing_stand
...
tp @s ^ ^ ^0.01
execute if score $ray gm4_count matches 0..500 at @s unless score $found gm4_count matches 1 run function gm4_brewing-1.1:ray_backup
