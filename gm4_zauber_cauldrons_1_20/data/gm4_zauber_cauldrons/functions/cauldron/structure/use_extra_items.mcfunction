...
execute if score $has_bottle gm4_zc_fullness matches 1.. if score @s gm4_zc_fullness matches 2.. align xyz positioned ~0.5 ~0.5 ~0.5 run function gm4_zauber_cauldrons:cauldron/extra_items/prepare_bottle
