...
# particles
execute if score $has_water gm4_zc_data matches 1 run particle minecraft:poof ~0.5 ~0.5 ~0.5 0.005 0.2 0.005 0.0005 4
execute if score $has_powder_snow gm4_zc_data matches 1 run particle minecraft:dripping_water ~0.5 ~0.88 ~0.5 0.14 0 0.14 1 1
...
execute if score @s gm4_zc_fullness matches 1.. positioned ~0.5 ~0.5 ~0.5 run function gm4_zauber_cauldrons:cauldron/recipe_checks
