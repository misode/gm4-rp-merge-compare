...
execute if score @s gm4_zc_moon_phase = $current gm4_zc_moon_phase if function gm4_zauber_cauldrons:cauldron/liquid/magicol/check_moon_phase run particle minecraft:electric_spark ~ ~0.2 ~ 0.15 0.15 0.15 0.01 3 normal @a[distance=..8, advancements={gm4_zauber_cauldrons:equipment/has_full_armor=true}]
