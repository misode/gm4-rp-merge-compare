...
particle minecraft:portal ~ ~0.8 ~ 0.25 0.25 0.25 0 100 force @a[distance=..32]
execute positioned ~ ~0.7 ~ run playsound minecraft:entity.enderman.teleport player @a[distance=..8] ~ ~ ~ 1 0.3
...
execute unless entity @e[tag=gm4_zc_wormhole_consumer, scores={gm4_zc_no_explode=1..}, limit=1] unless block ~ ~ ~ #minecraft:cauldrons run summon tnt ~0.5 ~0.7 ~0.5
