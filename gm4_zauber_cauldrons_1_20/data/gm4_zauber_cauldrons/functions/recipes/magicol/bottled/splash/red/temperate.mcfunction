...
# run from recipes/magicol/bottled/splash/red/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/splash/red/temperate
