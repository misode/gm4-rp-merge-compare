# @s = heated green magicol zauber cauldron with bottled green magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/drinkable/green/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/drinkable/green/temperate
