# @s = heated white magicol zauber cauldron with bottled white magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/drinkable/white/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/drinkable/white/temperate
