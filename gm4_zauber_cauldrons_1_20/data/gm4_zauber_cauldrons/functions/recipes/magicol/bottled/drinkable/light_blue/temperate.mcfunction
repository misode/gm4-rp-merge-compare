# @s = heated light_blue magicol zauber cauldron with bottled light_blue magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/drinkable/light_blue/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/drinkable/light_blue/temperate
