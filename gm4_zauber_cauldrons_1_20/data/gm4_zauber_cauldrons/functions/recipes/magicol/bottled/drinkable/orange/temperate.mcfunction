# @s = heated orange magicol zauber cauldron with bottled orange magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/drinkable/orange/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/drinkable/orange/temperate
