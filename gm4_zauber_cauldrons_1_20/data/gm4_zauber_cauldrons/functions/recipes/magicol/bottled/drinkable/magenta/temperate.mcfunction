# @s = heated magenta magicol zauber cauldron with bottled magenta magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/drinkable/magenta/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/drinkable/magenta/temperate
