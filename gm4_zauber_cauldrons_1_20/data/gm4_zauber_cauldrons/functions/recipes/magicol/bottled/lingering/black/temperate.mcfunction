# @s = heated black magicol zauber cauldron with bottled black magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/lingering/black/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/lingering/black/temperate
