# @s = heated pink magicol zauber cauldron with bottled pink magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/lingering/pink/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/lingering/pink/temperate
