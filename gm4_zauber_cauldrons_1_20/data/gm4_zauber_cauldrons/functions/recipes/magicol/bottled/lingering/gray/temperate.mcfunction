# @s = heated gray magicol zauber cauldron with bottled gray magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/lingering/gray/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/lingering/gray/temperate
