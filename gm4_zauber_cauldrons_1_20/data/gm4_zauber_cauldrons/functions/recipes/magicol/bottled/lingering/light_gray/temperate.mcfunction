# @s = heated light_gray magicol zauber cauldron with bottled light_gray magicol recipe inside
# at @s (center of block)
# run from recipes/magicol/bottled/lingering/light_gray/select_weather_modifier
...
# summon item
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/bottled_magicol/lingering/light_gray/temperate
