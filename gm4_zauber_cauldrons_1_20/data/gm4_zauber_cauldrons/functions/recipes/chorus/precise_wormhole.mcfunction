...
# summon wormhole
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/wormhole
...
# cosmetics
execute at @s run particle minecraft:witch ~ ~0.3 ~ 0.1 0.1 0.1 1 17
execute at @s run playsound minecraft:entity.ender_eye.death master @a[distance=..8] ~ ~ ~ 0.6 0.2
