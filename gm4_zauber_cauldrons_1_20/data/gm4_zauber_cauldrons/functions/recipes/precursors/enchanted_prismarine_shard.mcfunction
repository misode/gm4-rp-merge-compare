...
# recipe
loot spawn ~ ~0.2 ~ loot gm4_zauber_cauldrons:items/enchanted_prismarine_shard
...
# sounds and visuals
playsound block.portal.travel block @a[distance=..16] ~ ~ ~ 0.2 1.2
particle enchanted_hit ~ ~0.4 ~ 0.1 0.1 0.1 0.15 10
