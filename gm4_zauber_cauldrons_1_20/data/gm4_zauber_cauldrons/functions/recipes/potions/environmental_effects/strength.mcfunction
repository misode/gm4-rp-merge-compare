...
# place fire
execute if predicate gm4_zauber_cauldrons:cauldron/fire_chance if block ~-1 ~ ~-1 #gm4:replaceable run setblock ~-1 ~ ~-1 fire destroy
execute if predicate gm4_zauber_cauldrons:cauldron/fire_chance if block ~-1 ~ ~ #gm4:replaceable run setblock ~-1 ~ ~ fire destroy
execute if predicate gm4_zauber_cauldrons:cauldron/fire_chance if block ~-1 ~ ~1 #gm4:replaceable run setblock ~-1 ~ ~1 fire destroy
execute if predicate gm4_zauber_cauldrons:cauldron/fire_chance if block ~ ~ ~-1 #gm4:replaceable run setblock ~ ~ ~-1 fire destroy
execute if predicate gm4_zauber_cauldrons:cauldron/fire_chance if block ~ ~ ~1 #gm4:replaceable run setblock ~ ~ ~1 fire destroy
execute if predicate gm4_zauber_cauldrons:cauldron/fire_chance if block ~1 ~ ~-1 #gm4:replaceable run setblock ~1 ~ ~-1 fire destroy
