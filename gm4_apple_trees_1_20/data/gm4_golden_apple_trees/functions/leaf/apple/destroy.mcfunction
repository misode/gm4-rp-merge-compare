...
# drop apple
execute if predicate gm4_golden_apple_trees:apple_holding positioned ~0.5 ~2.5 ~0.5 positioned ^-0.25 ^ ^0.1 run function gm4_golden_apple_trees:leaf/apple/drop
