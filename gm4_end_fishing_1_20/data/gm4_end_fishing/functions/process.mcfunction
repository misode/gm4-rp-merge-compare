...
execute if score @s gm4_ef_timer matches 0 run schedule function gm4_end_fishing:go_fish/bobber_animation_clock 1

# particle
execute at @e[type=minecraft:fishing_bobber, limit=1, distance=..0.0001] run particle minecraft:end_rod ~ ~ ~ 0 0 0 0.02 1 force
