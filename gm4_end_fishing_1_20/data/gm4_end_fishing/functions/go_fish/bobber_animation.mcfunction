...
execute if score @s gm4_ef_data matches 5 run schedule function gm4_end_fishing:go_fish/update_bobber 1
...
execute if score @s gm4_ef_data matches 15 run schedule function gm4_end_fishing:go_fish/update_bobber 1
