...
execute unless block ~0.29 ~ ~ activator_rail[powered=true] unless block ~-0.29 ~ ~ activator_rail[powered=true] unless block ~ ~ ~0.29 activator_rail[powered=true] unless block ~ ~ ~-0.29 activator_rail[powered=true] run scoreboard players set can_spawn gm4_spawner_data 1
