...
execute unless entity @e[type=text_display, tag=gm4_bookshelf_inspector_display.removing] run schedule function gm4_bookshelf_inspector:process_display/remove/tick 1
