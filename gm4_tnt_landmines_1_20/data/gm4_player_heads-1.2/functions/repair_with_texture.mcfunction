...
execute if score continue gm4_player_heads matches 0 run function gm4_player_heads-1.2:found_match
execute if score continue gm4_player_heads matches 1 run data remove storage gm4_player_heads:register temp[-1]
execute if score continue gm4_player_heads matches 1 if data storage gm4_player_heads:register temp[0] run function gm4_player_heads-1.2:repair_with_texture
