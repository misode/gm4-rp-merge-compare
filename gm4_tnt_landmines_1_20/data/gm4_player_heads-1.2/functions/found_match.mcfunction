...
execute if score $use_loot_table gm4_player_heads matches 1 at @s run function gm4_player_heads-1.2:call_loot_table with storage gm4_player_heads:register macro
