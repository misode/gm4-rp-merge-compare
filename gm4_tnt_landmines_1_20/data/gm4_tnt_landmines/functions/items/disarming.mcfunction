...
#return item
summon item ~ ~1 ~ {Tags:["gm4_mine_checked","gm4_mine_new"],PickupDelay:30s,Motion:[0.0d,0.4d,0.0d],Item:{id:":player_head",Count:1b,tag:{SkullOwner:{Id:[I;-1172284621,-1030471482,-1585707380,-40076772],Properties:{textures:[{Value:""}]}},gm4_tnt_landmines:{item:"landmine",block:"minecraft:tnt"},display:{Name:'{"italic":false,"translate":"item.gm4.tnt_landmine","fallback":"Landmine"}',Lore:['{"translate":"item.gm4.tnt_landmine.use","fallback":"Drop to use"}']}}}}
