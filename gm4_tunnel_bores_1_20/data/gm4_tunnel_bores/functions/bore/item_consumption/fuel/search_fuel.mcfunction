...
execute at @s align xyz positioned ~0.5 ~0.5 ~0.5 store success score found_supply_cart gm4_bore_fuel run tag @e[type=minecraft:chest_minecart, distance=..1.4, limit=1] add gm4_bore_supply_minecart
