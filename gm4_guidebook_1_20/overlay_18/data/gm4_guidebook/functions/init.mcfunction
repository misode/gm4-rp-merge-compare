...
schedule function gm4_guidebook:update_storage/setup_markers 1

schedule function #gm4_guidebook:setup_storage 5
...
schedule function gm4_guidebook:main 2
schedule function gm4_guidebook:tick 1
