...
particle minecraft:block stripped_acacia_log ~ ~ ~ 0.2 0.2 0.2 0.1 10

execute if entity @s[type=item_frame] run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b},PickupDelay:10s,Motion:[0.0d,0.25d,0.0d]}
execute if entity @s[type=glow_item_frame] run summon item ~ ~ ~ {Item:{id:"minecraft:glow_item_frame",Count:1b},PickupDelay:10s,Motion:[0.0d,0.25d,0.0d]}
