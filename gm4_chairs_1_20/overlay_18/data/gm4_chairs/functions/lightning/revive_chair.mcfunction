...
# spawn chair
summon minecraft:pig ~ ~-10000 ~ {Tags:["gm4_chairs","smithed.entity","smithed.strict","smithed.block"],Team:"gm4_chairs",NoAI:1b,Saddle:1b,NoGravity:1b,Silent:1b,DeathTime:19s,InLove:2147483647,Attributes:[{Name:"generic.movement_speed",Base:0.0d}],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:2147483647,show_particles:0b},{id:"minecraft:resistance",amplifier:10b,duration:2147483647,show_particles:0b}],DeathLootTable:"minecraft:empty"}
