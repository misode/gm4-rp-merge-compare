...
execute if entity @s[tag=gm4_ce_totem.resistance] run particle dust 0.6 0.271 0.227 2 ^-0.3 ^1.45 ^0.3 0 0 0 0 0 normal
execute if entity @s[tag=gm4_ce_totem.speed] run particle dust 0.486 0.686 0.776 2 ^0.3 ^1.45 ^-0.3 0 0 0 0 0 normal
execute if entity @s[tag=gm4_ce_totem.strength] run particle dust 0.988 0.773 0.0 2 ^-0.3 ^1.45 ^-0.3 0 0 0 0 0 normal
