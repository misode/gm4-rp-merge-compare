...
execute if score @s gm4_particle matches 1 run particle minecraft:heart ~ ~0.2 ~ 0.2 0 0.2 0 1
execute if score @s gm4_particle matches 2 run particle minecraft:flame ~ ~0.15 ~ 0 0 0 0 1 force
execute if score @s gm4_particle matches 3 run particle minecraft:block_marker minecraft:barrier ~ ~0.5 ~ 0 0 0 0 1
execute if score @s gm4_particle matches 4 run particle minecraft:end_rod ~ ~ ~ 10 10 10 0 8 force
execute if score @s gm4_particle matches 7 run particle minecraft:happy_villager ~ ~0.3 ~ 2 0.2 2 0 1
...
execute if score @s gm4_particle matches 18 run particle minecraft:note ~ ~0.5 ~ 0.2 0.2 0.2 1 1
