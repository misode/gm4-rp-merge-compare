...
execute if entity @e[type=armor_stand, tag=gm4_bas_no_arms] run schedule function gm4_better_armour_stands:toggle/arms/check 16
execute if entity @e[type=armor_stand, tag=gm4_bas_temp_unlock] run schedule function gm4_better_armour_stands:toggle/lock/check 16
execute if entity @e[type=armor_stand, tag=gm4_bas_track] run schedule function gm4_better_armour_stands:pose/check_no_player 16
