...
execute if score $gravity gm4_bas_data matches 0 run particle minecraft:reverse_portal ~ ~ ~ 0.2 1 0.2 0 20

execute if score $gravity gm4_bas_data matches 1 run data modify entity @s NoGravity set value 0
execute if score $gravity gm4_bas_data matches 1 run particle minecraft:portal ~ ~ ~ 0.2 1 0.2 0 20
