...
execute if score $size gm4_bas_data matches 0 run playsound minecraft:entity.puffer_fish.blow_out block @a[distance=..6] ~ ~ ~ 0.3 2

execute if score $size gm4_bas_data matches 1 run data modify entity @s Small set value 0
execute if score $size gm4_bas_data matches 1 run playsound minecraft:entity.puffer_fish.blow_up block @a[distance=..6] ~ ~ ~ 0.3 2
