...
execute if score $size gm4_bas_data matches 0 positioned ~ ~1.4 ~ run particle block oak_planks ^0.35 ^ ^ 0 0 0 0 4
execute if score $size gm4_bas_data matches 0 positioned ~ ~1.4 ~ run particle block oak_planks ^-0.35 ^ ^ 0 0 0 0 4

execute if score $size gm4_bas_data matches 1 positioned ~ ~0.7 ~ run particle block oak_planks ^0.2 ^ ^ 0 0 0 0 4
execute if score $size gm4_bas_data matches 1 positioned ~ ~0.7 ~ run particle block oak_planks ^-0.2 ^ ^ 0 0 0 0 4
