...
execute if score $size gm4_bas_data matches 1 run summon marker ~ ~0.7 ~ {CustomName:'"gm4_bas_body"',Tags:["smithed.entity","smithed.strict","gm4_bas_joint","gm4_bas_body","gm4_bas_marker","gm4_bas_new","gm4_bas_temp"]}
