...
execute if score $size gm4_bas_data matches 0 positioned ~ ~1.4 ~ run particle electric_spark ^0.3 ^ ^ 0 0 0 0 1
execute if score $size gm4_bas_data matches 1 positioned ~ ~0.7 ~ run particle electric_spark ^0.15 ^ ^ 0 0 0 0 1

execute if score $size gm4_bas_data matches 0 positioned ~ ~1.4 ~ run particle electric_spark ^-0.3 ^ ^ 0 0 0 0 1
execute if score $size gm4_bas_data matches 1 positioned ~ ~0.7 ~ run particle electric_spark ^-0.15 ^ ^ 0 0 0 0 1

execute if score $size gm4_bas_data matches 0 positioned ~ ~0.8 ~ run particle electric_spark ^0.15 ^ ^ 0 0 0 0 1
execute if score $size gm4_bas_data matches 1 positioned ~ ~0.4 ~ run particle electric_spark ^0.05 ^ ^ 0 0 0 0 1
