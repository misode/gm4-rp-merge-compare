...
execute if score @s gm4_bas_dist matches 5 run tp @s ^ ^ ^0.5
...
execute store result entity @s[tag=!gm4_bas_move_alt] Pos[0] double 0.001 run scoreboard players operation $as_pos_x gm4_bas_data += @s gm4_bas_dx
execute store result entity @s[tag=!gm4_bas_move_alt] Pos[2] double 0.001 run scoreboard players operation $as_pos_z gm4_bas_data += @s gm4_bas_dz
execute store result entity @s Pos[1] double 0.001 run scoreboard players operation $as_pos_y gm4_bas_data += @s gm4_bas_dy
