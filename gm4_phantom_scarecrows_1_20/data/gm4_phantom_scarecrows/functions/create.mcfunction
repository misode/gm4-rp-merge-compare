...
#lock slots
data merge entity @s[tag=gm4_phantom_scarecrow] {Invisible:0b,Invulnerable:0b,DisabledSlots:2039583,ShowArms:1b,Pose:{LeftArm:[346.0f,0.0f,274.0f],RightArm:[350.0f,0.0f,85.0f]}}
