...
# located at @s
# run from gm4_custom_crafters-3.1:main
...
execute if entity @s[tag=gm4_custom_crafters_crafted] run function gm4_custom_crafters-3.1:process_input/check_cache
execute unless entity @s[tag=gm4_custom_crafters_crafted] run function gm4_custom_crafters-3.1:process_input/recipe_validity_check
