...
# located at @s
# run from gm4_custom_crafters-3.1:process_input/recipe_validity_check
...
execute unless data storage gm4_custom_crafters:temp/crafter Items[{Slot:0b}] unless data storage gm4_custom_crafters:temp/crafter Items[{Slot:1b}] unless data storage gm4_custom_crafters:temp/crafter Items[{Slot:2b}] run function gm4_custom_crafters-3.1:process_input/shift/shift_up
execute unless data storage gm4_custom_crafters:temp/crafter Items[{Slot:0b}] unless data storage gm4_custom_crafters:temp/crafter Items[{Slot:3b}] unless data storage gm4_custom_crafters:temp/crafter Items[{Slot:6b}] run function gm4_custom_crafters-3.1:process_input/shift/shift_left
...
function gm4_custom_crafters-3.1:process_input/check_item
...
execute unless score $crafted gm4_crafting matches 0 run function gm4_custom_crafters-3.1:process_output/finish_crafting
