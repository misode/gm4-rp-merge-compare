...
# located at @s
# run from gm4_custom_crafters-3.1:process
...
execute if score $stack_size gm4_crafting matches 1.. run function gm4_custom_crafters-3.1:process_input/attempt_craft
