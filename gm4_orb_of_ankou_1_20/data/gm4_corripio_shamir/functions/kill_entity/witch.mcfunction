# run from advancement kill_entity/witch
# @s = player who killed a witch using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/witch ~ ~ ~ mainhand
