# run from advancement kill_entity/silverfish
# @s = player who killed a silverfish using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/silverfish ~ ~ ~ mainhand
