# run from advancement kill_entity/zombie
# @s = player who killed a zombie using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/zombie ~ ~ ~ mainhand
