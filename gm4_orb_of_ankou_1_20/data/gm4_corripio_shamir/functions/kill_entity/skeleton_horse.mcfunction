# run from advancement kill_entity/skeleton_horse
# @s = player who killed a skeleton_horse using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/skeleton_horse ~ ~ ~ mainhand
