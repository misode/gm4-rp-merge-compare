# run from advancement kill_entity/llama
# @s = player who killed a llama using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/llama ~ ~ ~ mainhand
