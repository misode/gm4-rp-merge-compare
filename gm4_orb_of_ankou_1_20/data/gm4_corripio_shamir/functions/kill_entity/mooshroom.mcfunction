# run from advancement kill_entity/mooshroom
# @s = player who killed a mooshroom using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/mooshroom ~ ~ ~ mainhand
