# run from advancement kill_entity/slime
# @s = player who killed a slime using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/slime ~ ~ ~ mainhand
