# run from advancement kill_entity/phantom
# @s = player who killed a phantom using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/phantom ~ ~ ~ mainhand
