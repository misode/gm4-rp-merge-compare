# run from advancement kill_entity/endermite
# @s = player who killed a endermite using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/endermite ~ ~ ~ mainhand
