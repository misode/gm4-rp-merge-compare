# run from advancement kill_entity/zombified_piglin
# @s = player who killed a zombified_piglin using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/zombified_piglin ~ ~ ~ mainhand
