# run from advancement kill_entity/parrot
# @s = player who killed a parrot using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/parrot ~ ~ ~ mainhand
