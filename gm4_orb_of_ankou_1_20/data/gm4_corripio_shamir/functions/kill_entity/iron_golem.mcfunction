# run from advancement kill_entity/iron_golem
# @s = player who killed a iron_golem using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/iron_golem ~ ~ ~ mainhand
