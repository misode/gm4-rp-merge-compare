# run from advancement kill_entity/horse
# @s = player who killed a horse using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/horse ~ ~ ~ mainhand
