# run from advancement kill_entity/tropical_fish
# @s = player who killed a tropical_fish using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/tropical_fish ~ ~ ~ mainhand
