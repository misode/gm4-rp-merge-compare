# run from advancement kill_entity/magma_cube
# @s = player who killed a magma_cube using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/magma_cube ~ ~ ~ mainhand
