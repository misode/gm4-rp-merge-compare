# run from advancement kill_entity/piglin
# @s = player who killed a piglin using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/piglin ~ ~ ~ mainhand
