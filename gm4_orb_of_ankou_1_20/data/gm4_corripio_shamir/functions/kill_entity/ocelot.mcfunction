# run from advancement kill_entity/ocelot
# @s = player who killed a ocelot using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/ocelot ~ ~ ~ mainhand
