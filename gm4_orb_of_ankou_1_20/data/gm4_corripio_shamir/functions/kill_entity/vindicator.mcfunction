# run from advancement kill_entity/vindicator
# @s = player who killed a vindicator using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/vindicator ~ ~ ~ mainhand
