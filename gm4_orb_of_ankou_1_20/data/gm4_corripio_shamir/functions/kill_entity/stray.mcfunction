# run from advancement kill_entity/stray
# @s = player who killed a stray using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/stray ~ ~ ~ mainhand
