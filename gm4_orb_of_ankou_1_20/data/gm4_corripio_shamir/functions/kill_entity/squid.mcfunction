# run from advancement kill_entity/squid
# @s = player who killed a squid using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/squid ~ ~ ~ mainhand
