# run from advancement kill_entity/trader_llama
# @s = player who killed a trader_llama using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/trader_llama ~ ~ ~ mainhand
