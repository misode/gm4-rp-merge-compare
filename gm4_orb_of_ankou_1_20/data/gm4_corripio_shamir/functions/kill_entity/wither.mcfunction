# run from advancement kill_entity/wither
# @s = player who killed a wither using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/wither ~ ~ ~ mainhand
