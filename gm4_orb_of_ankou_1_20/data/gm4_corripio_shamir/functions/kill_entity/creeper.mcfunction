# run from advancement kill_entity/creeper
# @s = player who killed a creeper using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/creeper ~ ~ ~ mainhand
