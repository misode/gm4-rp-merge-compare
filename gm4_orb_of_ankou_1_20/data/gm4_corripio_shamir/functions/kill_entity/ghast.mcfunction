# run from advancement kill_entity/ghast
# @s = player who killed a ghast using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/ghast ~ ~ ~ mainhand
