# run from advancement kill_entity/dolphin
# @s = player who killed a dolphin using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/dolphin ~ ~ ~ mainhand
