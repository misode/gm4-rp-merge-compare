# run from advancement kill_entity/evoker
# @s = player who killed a evoker using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/evoker ~ ~ ~ mainhand
