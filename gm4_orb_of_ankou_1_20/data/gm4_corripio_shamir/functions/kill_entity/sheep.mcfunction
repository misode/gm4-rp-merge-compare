# run from advancement kill_entity/sheep
# @s = player who killed a sheep using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/sheep ~ ~ ~ mainhand
