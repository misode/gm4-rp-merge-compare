# run from advancement kill_entity/chicken
# @s = player who killed a chicken using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/chicken ~ ~ ~ mainhand
