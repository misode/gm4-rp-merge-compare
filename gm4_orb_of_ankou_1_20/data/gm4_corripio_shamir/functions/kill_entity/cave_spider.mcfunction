# run from advancement kill_entity/cave_spider
# @s = player who killed a cave_spider using the corripio shamir

loot spawn ~ ~0.3 ~ fish gm4_corripio_shamir:entities/cave_spider ~ ~ ~ mainhand
