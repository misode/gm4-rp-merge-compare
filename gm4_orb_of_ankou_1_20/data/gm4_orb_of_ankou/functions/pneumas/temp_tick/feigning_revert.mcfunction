...
execute if entity @e[type=#gm4_orb_of_ankou:feigning_affected, tag=gm4_oa_feigning, limit=1] run schedule function gm4_orb_of_ankou:pneumas/temp_tick/feigning_revert 1
