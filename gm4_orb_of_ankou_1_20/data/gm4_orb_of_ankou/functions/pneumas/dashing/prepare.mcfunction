...
execute rotated ~ 0 if block ^ ^0.9 ^0.1 #gm4:no_collision if block ^ ^0.5 ^1.1 #gm4:no_collision run summon armor_stand ^ ^0.5 ^1 {Invisible:1b,Small:1b,Invulnerable:1b,CustomName:'"Dashing Stand"',Tags:["gm4_oa_dasher","gm4_oa_new_dasher","smithed.entity","smithed.strict"],Attributes:[{Name:"generic.max_health",Base:1.0d}]}
...
schedule function gm4_orb_of_ankou:pneumas/dashing/temp_tick 1
