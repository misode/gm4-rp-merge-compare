...
execute if score $health gm4_pneuma_data matches 1.. run execute store result entity @s Health float 0.01 run scoreboard players get $health gm4_pneuma_data
