...
execute if score @s gm4_oa_powder matches 1.. run particle dust 0.459 0.2 0.09 2 ~ ~0.2 ~ 0.1 0.8 0.1 0.03 6 force
...
execute if score @s gm4_oa_essence matches 1.. run particle dust 0.18 0.169 0.31 2 ~ ~0.2 ~ 0.1 0.8 0.1 0.03 6 force
execute if entity @s[tag=gm4_oa_has_orb] run particle dust 0.725 0.729 0.78 2 ~ ~0.2 ~ 0.1 0.8 0.1 0.03 6 force
