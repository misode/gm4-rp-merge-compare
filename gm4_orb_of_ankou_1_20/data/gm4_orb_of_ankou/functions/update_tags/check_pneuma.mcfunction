...
# run tick functions
execute if entity @a[gamemode=!spectator, tag=gm4_pneuma_agile, limit=1] run schedule function gm4_orb_of_ankou:pneumas/temp_tick/agile 1
execute if entity @a[gamemode=!spectator, tag=gm4_pneuma_hawkeye, limit=1] run schedule function gm4_orb_of_ankou:pneumas/temp_tick/hawkeye 1
execute if entity @a[gamemode=!spectator, tag=gm4_pneuma_striding, limit=1] run schedule function gm4_orb_of_ankou:pneumas/temp_tick/striding 1
