...
# revoke advancement
advancement revoke @s only gm4_brewing-1.1:place_brewing_stand
...
execute as @e[type=marker,tag=gm4_brewing_ray,limit=1] at @s run function gm4_brewing-1.1:ray
...
execute unless score $found gm4_count matches 1 as @e[type=marker,tag=gm4_brewing_ray,limit=1] at @s run function gm4_brewing-1.1:ray_backup
