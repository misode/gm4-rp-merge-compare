...
summon minecraft:area_effect_cloud 29999998 1 7134 {CustomName:'"gm4_phantom_spawn_point"',Tags:["gm4_phantom_spawn_point"],Duration:1,Radius:0.0f,Particle:"block air"}
