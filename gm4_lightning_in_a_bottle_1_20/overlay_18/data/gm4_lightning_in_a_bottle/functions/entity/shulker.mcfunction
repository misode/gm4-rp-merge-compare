...
setblock ~ ~ ~ air
summon shulker ~ ~-0.49 ~ {active_effects:[{id:"minecraft:regeneration",duration:20,amplifier:10b,show_particles:0b}],Color:16,DeathLootTable:"gm4_lightning_in_a_bottle:entities/shulker"}
