...
execute as @e[type=illusioner, tag=gm4_liab_new_illusioner] run execute unless data entity @s DeathLootTable run data merge entity @s {DeathLootTable:"gm4_lightning_in_a_bottle:entities/illusioner",Health:32.0f}
