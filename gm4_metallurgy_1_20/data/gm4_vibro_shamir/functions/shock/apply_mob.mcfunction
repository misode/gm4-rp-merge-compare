...
execute if score $health gm4_vibro_shock matches 1.. run execute store result entity @s Health float 0.01 run scoreboard players get $health gm4_vibro_shock
...
particle minecraft:crit ~ ~0.5 ~ 0 0 0 0.5 20
particle minecraft:damage_indicator ~ ~0.5 ~ 0 0 0 0.5 5
