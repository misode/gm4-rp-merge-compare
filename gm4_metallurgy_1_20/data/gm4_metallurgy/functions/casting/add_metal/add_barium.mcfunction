...
execute if score $is_obsidian_cast gm4_ml_data matches 1.. run summon item ~0.45 ~0.1 ~0.65 {Item:{id:"minecraft:obsidian",Count:1b,tag:{CustomModelData:3420001,display:{Lore:['{"translate":"item.gm4.slightly_damaged_obsidian","fallback":"Slightly Damaged Obsidian","color":"dark_gray"}']}}}}
execute unless score $is_obsidian_cast gm4_ml_data matches 1.. run particle block granite ~0.45 ~0.1 ~0.65 0.1 0.1 0.1 0 9
particle block white_concrete_powder ~0.45 ~0.1 ~0.65 0.1 0.1 0.1 0 2
playsound item.bucket.empty_lava block @a[distance=..8] ~ ~ ~ 0.25 1.5
