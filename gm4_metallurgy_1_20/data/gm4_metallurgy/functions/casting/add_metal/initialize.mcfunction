...
execute as @e[type=item, tag=!gm4_ml_in_animation, dx=0, dz=0, limit=1, nbt={Item:{Count:1b,tag:{gm4_metallurgy:{metal:{castable:1b}}}},OnGround:1b}] run data merge entity @s {Motion:[0.0d,0.35d,0.0d],PickupDelay:30,Tags:["gm4_ml_in_animation"],Item:{tag:{gm4_metallurgy:{ore_in_animation:1b}}}}
