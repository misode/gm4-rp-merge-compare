...
execute unless score $is_obsidian_cast gm4_ml_data matches 1.. run particle block diorite ~0.45 ~0.1 ~0.65 0.1 0.1 0.1 0 9
particle block dead_fire_coral_block ~0.45 ~0.1 ~0.65 0.1 0.1 0.1 0 2
