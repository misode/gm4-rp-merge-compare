...
#sounds
execute if entity @e[tag=gm4_in_infinitas, distance=6..8] run playsound ui.toast.out player @a[distance=..10] ~ ~ ~ 0.5 0.1
execute if entity @e[tag=gm4_in_infinitas, distance=3..5.99] run playsound ui.toast.out player @a[distance=..10] ~ ~ ~ 0.5 0.3
execute if entity @e[tag=gm4_in_infinitas, distance=..2.99] run playsound ui.toast.out player @a[distance=..10] ~ ~ ~ 0.5 0.7
