...
summon armor_stand ~ ~-0.4 ~ {Silent:1b,Small:1,NoGravity:1,Marker:1,Invulnerable:1,Invisible:1,DisabledSlots:2039552,Tags:["gm4_smeltery","gm4_no_edit","gm4_machine"],Rotation:[45.0f,0.0f],HasVisualFire:1,CustomName:'"gm4_smeltery"',ArmorItems:[{},{},{},{id:"minecraft:gray_stained_glass",Count:1,tag:{CustomModelData:3420001}}],HandItems:[{},{id:"minecraft:stone_button",Count:1b,tag:{CustomModelData:3420005}}],Pose:{LeftArm:[0.0f,0.0f,0.0f]}}
