...
data merge entity @s[tag=gm4_taut_link, tag=gm4_zipping_north] {Motion:[0.0d,0.06d,-0.4d]}
data merge entity @s[tag=gm4_taut_link, tag=gm4_zipping_south] {Motion:[0.0d,0.06d,0.4d]}
data merge entity @s[tag=gm4_taut_link, tag=gm4_zipping_east] {Motion:[0.4d,0.06d,0.0d]}
data merge entity @s[tag=gm4_taut_link, tag=gm4_zipping_west] {Motion:[-0.4d,0.06d,0.0d]}
