...
execute if score $target_door_state gm4_double_doors_data matches 0 run place template gm4_double_doors:mangrove/door/north/right/closed ~ ~ ~

# player just opened a door
execute if score $target_door_state gm4_double_doors_data matches 1 run place template gm4_double_doors:mangrove/door/north/right/open ~ ~ ~
...
execute positioned ~ ~2 ~ if block ~ ~ ~ minecraft:mangrove_trapdoor[open=true, half=bottom] unless block ~ ~ ~ minecraft:mangrove_trapdoor[facing=east] unless block ~ ~ ~ minecraft:mangrove_trapdoor[facing=south] run function gm4_double_doors:mangrove/trapdoor/north_west/check_neighbours
...
execute unless score $triggered_by_auto_toggle gm4_double_doors_data matches 1.. summon marker run function gm4_double_doors:mangrove/door/north/right/initialize_auto_toggle_marker
