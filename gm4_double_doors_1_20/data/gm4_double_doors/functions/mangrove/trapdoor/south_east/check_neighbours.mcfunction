...
# run from gm4_double_doors:mangrove/door/east/left/toggle and gm4_double_doors:mangrove/door/south/right/toggle

# open this trapdoor
function gm4_double_doors:mangrove/trapdoor/south_east/toggle
