...
execute if score $target_door_state gm4_double_doors_data matches 0 run place template gm4_double_doors:oak/door/north/left/closed ~ ~ ~

# player just opened a door
execute if score $target_door_state gm4_double_doors_data matches 1 run place template gm4_double_doors:oak/door/north/left/open ~ ~ ~
...
execute positioned ~ ~2 ~ if block ~ ~ ~ minecraft:oak_trapdoor[open=true, half=bottom] unless block ~ ~ ~ minecraft:oak_trapdoor[facing=west] unless block ~ ~ ~ minecraft:oak_trapdoor[facing=south] run function gm4_double_doors:oak/trapdoor/north_east/check_neighbours
...
execute unless score $triggered_by_auto_toggle gm4_double_doors_data matches 1.. summon marker run function gm4_double_doors:oak/door/north/left/initialize_auto_toggle_marker
