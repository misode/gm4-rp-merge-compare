...
execute if block ~ ~ ~ minecraft:spruce_door[open=true] run scoreboard players set $target_door_state gm4_double_doors_data 1
...
execute if block ~ ~ ~ minecraft:spruce_door[half=upper] positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:spruce_door[half=lower] run function gm4_double_doors:spruce/door/get_facing
execute if block ~ ~ ~ minecraft:spruce_door[half=lower] if block ~ ~1 ~ minecraft:spruce_door[half=upper] run function gm4_double_doors:spruce/door/get_facing
