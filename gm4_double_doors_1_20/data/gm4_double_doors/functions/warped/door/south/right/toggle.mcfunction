...
# run from check_neighbours functions in gm4_double_doors:warped/door/...

# player just closed a door
execute if score $target_door_state gm4_double_doors_data matches 0 run place template gm4_double_doors:warped/door/south/right/closed ~ ~ ~

# player just opened a door
execute if score $target_door_state gm4_double_doors_data matches 1 run place template gm4_double_doors:warped/door/south/right/open ~ ~ ~
...
execute positioned ~ ~2 ~ if block ~ ~ ~ minecraft:warped_trapdoor[open=true, half=bottom] unless block ~ ~ ~ minecraft:warped_trapdoor[facing=west] unless block ~ ~ ~ minecraft:warped_trapdoor[facing=north] run function gm4_double_doors:warped/trapdoor/south_east/check_neighbours
...
execute unless score $triggered_by_auto_toggle gm4_double_doors_data matches 1.. summon marker run function gm4_double_doors:warped/door/south/right/initialize_auto_toggle_marker
