...
# run from gm4_double_doors:dark_oak/door/north/right/toggle and gm4_double_doors:dark_oak/door/west/left/toggle

# open this trapdoor
function gm4_double_doors:dark_oak/trapdoor/north_west/toggle
