...
# run from gm4_double_doors:dark_oak/door/east/right/toggle and gm4_double_doors:dark_oak/door/north/left/toggle

# open this trapdoor
function gm4_double_doors:dark_oak/trapdoor/north_east/toggle
