...
# run from gm4_double_doors:acacia/door/east/left/toggle and gm4_double_doors:acacia/door/south/right/toggle

# open this trapdoor
function gm4_double_doors:acacia/trapdoor/south_east/toggle
