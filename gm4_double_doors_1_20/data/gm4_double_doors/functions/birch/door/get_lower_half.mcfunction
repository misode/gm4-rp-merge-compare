...
execute if block ~ ~ ~ minecraft:birch_door[open=true] run scoreboard players set $target_door_state gm4_double_doors_data 1
...
execute if block ~ ~ ~ minecraft:birch_door[half=upper] positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:birch_door[half=lower] run function gm4_double_doors:birch/door/get_facing
execute if block ~ ~ ~ minecraft:birch_door[half=lower] if block ~ ~1 ~ minecraft:birch_door[half=upper] run function gm4_double_doors:birch/door/get_facing
