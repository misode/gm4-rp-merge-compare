...
# run from gm4_double_doors:crimson/door/east/left/toggle and gm4_double_doors:crimson/door/south/right/toggle

# open this trapdoor
function gm4_double_doors:crimson/trapdoor/south_east/toggle
