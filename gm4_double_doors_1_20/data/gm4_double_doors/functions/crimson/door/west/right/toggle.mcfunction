...
execute if score $target_door_state gm4_double_doors_data matches 0 run place template gm4_double_doors:crimson/door/west/right/closed ~ ~ ~

# player just opened a door
execute if score $target_door_state gm4_double_doors_data matches 1 run place template gm4_double_doors:crimson/door/west/right/open ~ ~ ~
...
execute positioned ~ ~2 ~ if block ~ ~ ~ minecraft:crimson_trapdoor[open=true, half=bottom] unless block ~ ~ ~ minecraft:crimson_trapdoor[facing=east] unless block ~ ~ ~ minecraft:crimson_trapdoor[facing=north] run function gm4_double_doors:crimson/trapdoor/south_west/check_neighbours
...
execute unless score $triggered_by_auto_toggle gm4_double_doors_data matches 1.. summon marker run function gm4_double_doors:crimson/door/west/right/initialize_auto_toggle_marker
