...
# run from gm4_double_doors:bamboo/door/east/right/toggle and gm4_double_doors:bamboo/door/north/left/toggle

# open this trapdoor
function gm4_double_doors:bamboo/trapdoor/north_east/toggle
