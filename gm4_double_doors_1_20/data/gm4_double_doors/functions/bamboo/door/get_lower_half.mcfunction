...
execute if block ~ ~ ~ minecraft:bamboo_door[half=upper] positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:bamboo_door[half=lower] run function gm4_double_doors:bamboo/door/get_facing
execute if block ~ ~ ~ minecraft:bamboo_door[half=lower] if block ~ ~1 ~ minecraft:bamboo_door[half=upper] run function gm4_double_doors:bamboo/door/get_facing
