...
execute if data storage gm4:log log{type:"outdated"} run function gm4-1.4:outdated_logs/outdated_start
execute if data storage gm4:log log{type:"version_conflict"} run function gm4-1.4:conflict_logs/version_conflict_start

data remove storage gm4:log queue[0]
execute store result score #log_size gm4_data run data get storage gm4:log queue
execute if score #log_size gm4_data matches 1.. run function gm4-1.4:log
