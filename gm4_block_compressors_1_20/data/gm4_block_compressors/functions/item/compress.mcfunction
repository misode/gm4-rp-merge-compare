...
execute as 00344d47-0004-0004-0004-000f04ce104d run loot replace entity @s weapon.offhand loot gm4_block_compressors:technical/compressed_lore
execute as 00344d47-0004-0004-0004-000f04ce104d run data modify storage gm4_block_compressors:temp/item_stack Item.tag.display.Lore append from entity @s HandItems[1].tag.display.Name
data merge entity 00344d47-0004-0004-0004-000f04ce104d {HandItems:[{},{}]}
